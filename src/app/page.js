...
export default function Home() {
  ...
  return (
    ...
    <div className="flex flex-col w-full h-fit items-center  mb-[20px]">
      <div className="lg:w-90p w-full h-fit text-[40px]">
        튜토리얼!!!!!!!읽고가라!!!!!!!!!
      </div>

      <div className="w-full h-fit flex flex-col items-center mb-[20px]" >
          <p className="lg:w-90p w-full text-[25px] text-blue-300 ">링크 넣기</p>
          <p className="lg:w-90p w-full text-[15px] ">링크를 넣고싶다면은 $$~~$$ 이런식으로 $$으로 열고 닫아주자.<br/> 특히 이미지 영상 링크들이 모두가지는 자료의 소스는
      ...
      <div className="w-full h-fit flex flex-col items-center mb-[20px]">
          <p className="lg:w-90p w-full text-[25px] text-blue-300 ">작은 박스와 큰 박스</p>
          <p className="lg:w-90p w-full text-[15px]">두 박스 모두 그안의 영역에 자유롭게 요소들을 넣을수있는 공간이다.<br/>
      ...
      <div className="w-full h-fit flex flex-col items-center mb-[20px]">
          <p className="lg:w-90p w-full text-[25px] text-blue-300 ">문서 서두 시작틀</p>
          <p className="lg:w-90p w-full text-[15px]">문서 서두의 시작틀은 ====x==== ~~ ====끝====로 구성된다.<br/>
      ...
      <div className="w-full h-fit flex flex-col items-center mb-[20px]">
          <p className="lg:w-90p w-full text-[25px] text-blue-300 ">각주 작성</p>
          <p className="lg:w-90p w-full text-[15px]">각주의 구성은 @~~  !~~!@ 이렇게 구성된다. <br/>
      ...
      <div className="w-full h-fit flex flex-col items-center mb-[20px]">
          <p className="lg:w-90p w-full text-[25px] text-blue-300 ">영상,이미지 삽입</p>
          <p className="lg:w-90p w-full text-[15px]">이미지 영상 삽입 <br/>
          이미지의 경우&&&~&&& 이고 <br/>
